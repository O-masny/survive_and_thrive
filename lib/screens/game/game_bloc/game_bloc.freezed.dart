...
class _$CreateRoomImpl implements _CreateRoom {
  const _$CreateRoomImpl(this.roomId, this.playerName);
...
abstract class _CreateRoom implements GameEvent {
  const factory _CreateRoom(final String roomId, final String playerName) =
      _$CreateRoomImpl;
...
class _$JoinRoomImpl implements _JoinRoom {
  const _$JoinRoomImpl(this.roomId, this.playerName);
...
abstract class _JoinRoom implements GameEvent {
  const factory _JoinRoom(final String roomId, final String playerName) =
      _$JoinRoomImpl;
...
class _$UpdateScoreImpl implements _UpdateScore {
  const _$UpdateScoreImpl(this.roomId, this.player, this.score);
...
abstract class _UpdateScore implements GameEvent {
  const factory _UpdateScore(
          final String roomId, final String player, final int score) =
      _$UpdateScoreImpl;
...
class _$LoadRoomImpl implements _LoadRoom {
  const _$LoadRoomImpl(this.roomId);
...
abstract class _LoadRoom implements GameEvent {
  const factory _LoadRoom(final String roomId) = _$LoadRoomImpl;
...
class _$GameStateImpl implements _GameState {
  ...
  @override
  String toString() {
    return 'GameState(roomId: $roomId, playerName: $playerName, player1Score: $player1Score, player2Score: $player2Score, currentQuestion: $currentQuestion)';
  }
...
abstract class _GameState implements GameState {
  const factory _GameState(
      ...
      required final int currentQuestion}) = _$GameStateImpl;
